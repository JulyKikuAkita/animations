...
struct ParticleEffectsView: View {
    ...
    @State private var keyframe: Bool = true
    ...
    var body: some View {
        VStack(spacing: 15) {
            HStack(spacing: 20){
                ...
                CustomButton(systemImage: "fireworks", status: firework, activeTint: .blue, inActiveTint: .gray) {
                    firework.toggle()
                }

                CustomButton(systemImage: "bubbles.and.sparkles", status: keyframe, activeTint: .orange, inActiveTint: .green, useKeyFrame: true) {
                    keyframe.toggle()
...
//                                    Image(systemName: "bubbles.and.sparkles")
    ...
    @ViewBuilder
    func CustomButton(systemImage: String, status: Bool, activeTint: Color, inActiveTint: Color, useKeyFrame: Bool = false, onTap: @escaping () -> ()) -> some View {
        Button(action: onTap) {
