...
struct StackedCards<Content: View, Data: RandomAccessCollection>: View where Data.Element: Identifiable {
    ...
    var body: some View {
        GeometryReader {
            ...
            .safeAreaPadding(.top, topPadding) /// add padding directly to scrollContent rather than scrollView (if using standard padding) and thus allowing to scroll the stack all the way up
        }
    }
